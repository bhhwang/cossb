...
const char* uuid = "51ba1b0e47e34a98abb4b1d1bae10960";
...
void setup()
{
  ...
  if(frame) {
    ...
    aJson.addBooleanToObject(frame, "io", false);
  }
}
...
{
  if(io==GPIN) {
    aJsonObject* gpio = aJson.getObjectItem(frame, "io");
